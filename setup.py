...
#
# However, when we do this, we also import `acme/__init__.py'. If this
...
setup_dict = dict(
    ...
    # TODO: See why enabling this breaks the linter
    ...
    install_requires=reqs + python_version_specific_requires,
    ...
    zip_safe=False,  # don't use eggs, they crack

    # entry_points={
    #   'console_scripts': [
    #       'acme_cli = acme.main:entry_point'
    #   ],
    # if you have a gui, use this
    #   'gui_scripts': [
    #       'acme_gui = acme.gui:entry_point'
    #   ]
    # }
)
